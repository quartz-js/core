...
export class UserApi
{
	...
	create(params)
	{
		return Vue.http.post(this.getFullUrl(), params, { headers: { Authorization: "Bearer "+this.access_token }});
	}
	...
	update(id, params)
	{
		return Vue.http.put(this.getFullUrl()+"/"+id, params, { headers: { Authorization: "Bearer "+this.access_token }});
	}
